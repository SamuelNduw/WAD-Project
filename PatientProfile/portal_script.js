...
// document.addEventListener("DOMContentLoaded", () => {
  ...
  chatSubmit.addEventListener("click", async () => {
    ...
    const response = await fetch("http://localhost:8000/hospital/chatbot/", {
      method: "POST",
    ...
    //         {
    //           role: "user",
    //           content: `${userInput} (give a maximum of two sententes in response)`,
    //         },
    //       ],
    //       keep_alive: 180,
    //       stream: true,
    ...
    //     "Error connecting to Ollama. Please try again later.";
    // }
    ...
    //     let botMessage = "";
    //     botMessage = await chatSession.sendMessage(`${userInput}`);
